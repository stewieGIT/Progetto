...
# le 4 funzioni creano grafi generati parzialmente in modo manuale per inserire cicli o non inserirne
# sono stati usati nella fase di progettazione
# NB se si cambia il seed per i grafi che utilizzano anche l'inserimento casuale di archi allora
# potrebbero non essere piu connessi
